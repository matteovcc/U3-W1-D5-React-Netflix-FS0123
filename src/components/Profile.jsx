...
const Profile = () => (
  <Container>
    <Row className="border-bottom border-secondary py-4">
      ...
      <Col xs={8} className="p-2">
        ...
        <p className="text-white">
          Show titles of{" "}
          <span className="fw-semibold">all maturity ratings</span> this
          profile.
        </p>
        <Button
          variant="dark"
          className="text-light-emphasis py-1 px-3 text-center border-secondary"
    ...
    <div className="d-flex justify-content-center my-4">
      ...
      <Button
        variant="dark"
        className="text-secondary border border-secondary me-5"
        style={{ letterSpacing: "0.1em" }}
      >
        CANCEL
      </Button>
